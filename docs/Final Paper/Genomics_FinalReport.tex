...
We used a Python implementation of Mash called SourMash.\cite{GitHub-Sourmash} It was 
The data that we tested on included 300+ E. coli genomes as well as multiple different yeast genomes.
