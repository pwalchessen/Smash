...
\begin{wrapfigure}{r}{0.25\textwidth}
    \centering
    \includegraphics[width=0.25\textwidth]{Mash_description}
...
We used a Python implementation of Mash called SourMash.\cite{GitHub-Sourmash} It was developed by Titus Brown and Luiz Irber from UC Davis and is available as open-source software from GitHub.
300+ E. coli genomes were compared between each other and a minimum distance of 0.378 was determined.\ref{fig:All Ecoli} The E. coli genomes were downloaded from the RefSeq database and a full list is available in the appendix.
